...
urlpatterns = patterns('',
        ...
        (r'^relationships/update_relationship_confidence/$', 'crits.relationships.views.update_relationship_confidence'),
        ...
        (r'^samples/upload/(?P<related_md5>\w+)/$', 'crits.samples.views.upload_file'),
