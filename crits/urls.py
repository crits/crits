...
urlpatterns = patterns('',
        ...
        (r'^actors/tags/modify/$', 'crits.actors.views.actor_tags_modify'),
        (r'^actors/tags/get$', 'crits.actors.views.get_actor_tags'),
        (r'^actors/identifiers/add$', 'crits.actors.views.add_identifier'),
        (r'^actors/identifiers/edit$', 'crits.actors.views.edit_identifier'),
        (r'^actors/identifiers/remove$', 'crits.actors.views.remove_identifier'),
