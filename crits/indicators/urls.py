...
urlpatterns = [
    ...
    url(r'^threat_type/update/(?P<indicator_id>\w+)/$', 'update_indicator_threat_type', prefix='crits.indicators.views'),
    url(r'^attack_type/update/(?P<indicator_id>\w+)/$', 'update_indicator_attack_type', prefix='crits.indicators.views'),
